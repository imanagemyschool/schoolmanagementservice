...
private class PlainTextSalt (
    ...
    override protected[hasher] def fill (
         ...
         * ATTENTION *
         *************
         * Two strings below are reversed in comparison to the original sources!
         * This was done to be compatible with existing hashing algorithm: SHA256("passwrd" + "salt"), default version
         *  concatenated in different order ("salt" + "password")
         */
        inner.fill( digest )
