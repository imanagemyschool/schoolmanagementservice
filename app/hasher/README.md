...
This is source files of the github project 'Nycto/Hasher'. Copied into this project to avoid suspicious maven dependencies.
Sources copied from v1.0.0. Tests aren't copied. File 'PlainText.scala' (PlainTextSalt class) is changed, so project is kind of forked.
